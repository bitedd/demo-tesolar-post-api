...
export class ServiceStack extends cdk.Stack {
  ...
  constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
    ...
    const vpc = new ec2.Vpc(this, 'DemoTesolarVPC', {
      cidr: '192.168.0.0/22',
      subnetConfiguration: [
        {
          name: 'Public',
    ...
    const repository = ecr.Repository.fromRepositoryName(this, 'Repository', 'demo-tesolar-post-api/app');
    const imageTag = process.env.CODEBUILD_RESOLVED_SOURCE_VERSION || 'local';

    const cluster = new ecs.Cluster(this, 'Cluster201222', {
      clusterName: 'cdk-cicd201222',
      vpc: vpc,
    });
